...
export const TOUR_STEPS:Step[] = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          This indicator tells you how dragging (and optionally scrolling) will affect the texture or view. You can change the drag mode by holding down different modifiers. Hover on the options to see their functions and the key combos that activate them.
        </p>
        Using scroll with modifiers may not be available in your browser so the use of dragging is recommended.  However, scrolling can have ergonomic benefits and there are workarounds to the browser default behaviours. You can disable ctrl+scroll in Chrome with
        {' '}
        <a
